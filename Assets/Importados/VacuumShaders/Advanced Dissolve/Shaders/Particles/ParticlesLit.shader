// ------------------------------------------
// No shadows
Shader "VacuumShaders/Advanced Dissolve/Lightweight Render Pipeline/Particles/Lit"
{
    Properties
    {
    ...
    Fallback "Lightweight Render Pipeline/Particles/Lit"
    CustomEditor "UnityEditor.Rendering.LWRP.ShaderGUI.AdvancedDisolve_ParticlesLitShader"
}
