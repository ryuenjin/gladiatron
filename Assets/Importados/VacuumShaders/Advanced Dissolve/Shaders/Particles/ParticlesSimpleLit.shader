...
// No shadow
// No distortion
Shader "VacuumShaders/Advanced Dissolve/Lightweight Render Pipeline/Particles/Simple Lit"
{
    Properties
    {
    ...
    Fallback "Lightweight Render Pipeline/Particles/Simple Lit"
    CustomEditor "UnityEditor.Rendering.LWRP.ShaderGUI.AdvancedDisolve_ParticlesSimpleLitShader"
}
