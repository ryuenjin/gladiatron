Shader "VacuumShaders/Advanced Dissolve/Lightweight Render Pipeline/Particles/Unlit"
{
    Properties
    {
    ...
    CustomEditor "UnityEditor.Rendering.LWRP.ShaderGUI.AdvancedDisolve_ParticlesUnlitShader"
}
