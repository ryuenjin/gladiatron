Shader "VacuumShaders/Advanced Dissolve/Lightweight Render Pipeline/Simple Lit"
{
    ...
    CustomEditor "UnityEditor.Rendering.LWRP.ShaderGUI.AdvancedDisolve_SimpleLitShader"
}
